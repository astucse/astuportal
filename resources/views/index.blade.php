...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="POST" action="{{route('any.login')}}">
         @csrf
      <div class="form-group has-feedback">
        <input type="text" name="email" class="form-control form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email or Id" value="{{ old('email') }}" required autofocus>
        @if ($errors->has('email'))
