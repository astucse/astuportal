...
@widget('breadcumb',['header'=>'Inbox Letters ','sub-header'=>'','link0'=>'Home','link1'=>'Office Automation','link9'=>'Create letter'])
<br>
				...
				@foreach($letters as $letter)
                  <tr>
                    ...
                    <td class="mailbox-name">
                    	<a href="{{route('officeautomation.employee.view_letter',['id'=>$letter->hashedId])}}">
...
<script type="text/javascript">
  ...
  $( "#officeautomation-Inboxletters" ).addClass( "active" );
</script>
<script>
  $(function () {
