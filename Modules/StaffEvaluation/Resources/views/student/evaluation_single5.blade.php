...
<section class="content">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{route('student.image',['id'=>$evaluationsession->staff->id])}}" alt="User profile picture">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Course title</b> <a class="pull-right">{{$evaluationsession->course->name}}</a>
                </li>
                <li class="list-group-item">
    ...
    <div id="example-basic">
        <br>
        @foreach($evaluationsession->student_evaluation->questionsByCategory as $k=>$q)
        <h3>{{$k}}</h3>
        <section>
